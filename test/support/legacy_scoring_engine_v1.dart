// Engine v1, restored verbatim from git (HEAD before the v2 rewrite) so
// tests can measure how often the OLD logic flipped on the same inputs.
// Test-only. Do not use in the app.

import 'package:replica_detector/data/authentication_rules.dart';
import 'package:replica_detector/data/reference_library.dart';
...
/// confidence (§23, §55).
abstract final class LegacyScoringEngineV1 {
  ...
  static LegacyScoringResult evaluate({
